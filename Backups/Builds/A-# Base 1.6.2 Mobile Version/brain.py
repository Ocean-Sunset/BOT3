for Whaaa in range(1000000):
	Wha1 = str(input("Begin start up? "))
	if Wha1 == "yes" or "Yes":
		import discord
...
token = "MTMyMzczNDAxMDM0NTY4OTE4OQ.GQBoA_.M-8XOcsxRPUpT1WDV0dBpbRODY8K6sBNBXJT-k"
...
async def info(ctx):
    ...
    Status: Unstable build (no ChatGPT 4.0)
    Version: 1.6.2 (Mobile version)
